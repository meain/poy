      ...
      <div className="App">
        ...
        <div className="App-content">
          ...
          <div className="App-login">
            <div className="App-login-text">Login with facebook to mark your vote.</div>
            <button className="App-facebook-login">Login with facebook</button>
          </div>
          ...
          {/* Hopping we have more than two people or it will look ugly */}
